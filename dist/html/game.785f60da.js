...
})({"azrzF":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f41d7fe6785f60da";
"use strict";
...
},{}],"2Su2V":[function(require,module,exports) {
var _gameEngineJs = require("./gameEngine.js");
...
buttonContainer.addEventListener("click", (event)=>{
    const scores = (0, _gameEngineJs.gameSetPlay)(event, name);
    if (scores[1] > 0) {
        (0, _gameEngineJs.resetScore)();
        (0, _scoreBoardJs.uppdateScoreboard)(scores[0], name);
    }
});
resetButton.addEventListener("click", (event)=>{
    (0, _scoreBoardJs.resetFirebaseScores)();
});

},{"./gameEngine.js":"50Jll","./scoreBoard.js":"cMnwi"}],"50Jll":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "gameSetPlay", ()=>gameSetPlay);
parcelHelpers.export(exports, "resetScore", ()=>resetScore);
...
const scissorsImgUrl = new URL(require("5e20044f70250ba6"));
const stoneImgUrl = new URL(require("bfe7c49a45b82f80"));
const paperImgUrl = new URL(require("30933c911bf2dd1c"));
//img.src = imgUrl.href;
...
function gameSetPlay(event, name) {
    ...
    if (playerChoice == 0 && opponentChoice == 1) opponentScore++;
        ...
        pointText.innerText = "One point to you!";
        playerScore++;
    } else if (playerChoice == 1 && opponentChoice == 2) opponentScore++;
    else if (playerChoice == 2 && opponentChoice == 0) opponentScore++;
    else if (playerChoice == 2 && opponentChoice == 1) {
        pointText.innerText = "One point to you!";
        playerScore++;
    } else pointText.innerText = "Its a draw!";
    currentScoreH1.innerText = "Score: " + playerScore;
    if (opponentScore > 0) announcement.innerText = "Your opponent wins!";
    return [
        playerScore,
        opponentScore
    ];
...
},{"5e20044f70250ba6":"7ukYC","bfe7c49a45b82f80":"6J0NB","30933c911bf2dd1c":"7c6G7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","animejs":"jokr5"}],"7ukYC":[function(require,module,exports) {
module.exports = require("d2c6a0facf5c2136").getBundleURL("kXq19") + "../scissors.1001099f.png" + "?" + Date.now();

},{"d2c6a0facf5c2136":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"6J0NB":[function(require,module,exports) {
module.exports = require("18b9ed73b12a870c").getBundleURL("kXq19") + "../stone.03d0fecc.png" + "?" + Date.now();

},{"18b9ed73b12a870c":"lgJ39"}],"7c6G7":[function(require,module,exports) {
module.exports = require("cebd3c038f6b03f1").getBundleURL("kXq19") + "../toilet-paper.7f873449.png" + "?" + Date.now();

},{"cebd3c038f6b03f1":"lgJ39"}],"gkKU3":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cMnwi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "uppdateScoreboard", ()=>uppdateScoreboard);
parcelHelpers.export(exports, "resetFirebaseScores", ()=>resetFirebaseScores);
var _htmlRequestsJs = require("./htmlRequests.js");
...
uppdateScoreboard(0, "");
function uppdateScoreboard(playerScore, playeName) {
    let allUsers = (0, _htmlRequestsJs.getFirebase)("https://rockpaperscissors-417c0-default-rtdb.europe-west1.firebasedatabase.app/.json");
...
async function checkForNewHighscore(playerScore, playeName, users) {
    let currentLowestUser = (0, _underscoreDefault.default).min(users, "highScore");
    if (playerScore > currentLowestUser.highScore) {
        console.log("new highscore");
        preparePatch(playeName, (0, _underscoreDefault.default).findIndex(users, currentLowestUser), playerScore);
    }
}
function sortMe(array) {
    const newArray = (0, _underscoreDefault.default).sortBy(array, "highScore").reverse();
...
function preparePatch(newName, index, newScore) {
    ...
    (0, _htmlRequestsJs.patchFirebase)(url, newValue);
}
function resetFirebaseScores() {
...
},{"./htmlRequests.js":"iqM4E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","underscore":"8o1Pk"}],"iqM4E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getFirebase", ()=>getFirebase);
parcelHelpers.export(exports, "patchFirebase", ()=>patchFirebase);
var _scoreBoardJs = require("./scoreBoard.js");
async function getFirebase(url) {
    const response = await fetch(url);
    const data = await response.json();
    //console.log(data);
    return data;
}
async function patchFirebase(url, newValue) {
    const option = {
        method: "PATCH",
    ...
    const data = await response.json();
    console.log(data);
    (0, _scoreBoardJs.uppdateScoreboard)(0, "");
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./scoreBoard.js":"cMnwi"}],"8o1Pk":[function(require,module,exports) {
// ESM Exports
// ===========
...
},{"./underscore.js":"cZn3h","./each.js":"fHmAz","./_setup.js":"j1Opz","./_chainResult.js":"2gkrX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["azrzF","2Su2V"], "2Su2V", "parcelRequirecb9a")

//# sourceMappingURL=game.785f60da.js.map
